...
#import "KYAddressBookContactObjectManager.h"
#import "KYContactObject.h"
//#import <objc/runtime.h>

//static NSString * const KYAddressBookContactsManager;

@implementation KYAddressBookContactObjectManager
//
//+(ABRecordRef)recordRef
//{
//    return (__bridge ABRecordRef)(objc_getAssociatedObject(self, &KYAddressBookContactsManager));
//}
//
//+(void)setRecordRef:(ABRecordRef)recordRef
//{
//    objc_setAssociatedObject(self, &KYAddressBookContactsManager, (__bridge id)(recordRef), OBJC_ASSOCIATION_ASSIGN);
//}
//
//-(void)dealloc
//{
 ...
 *  获得姓名的相关属性
 */
+ (KYContactNameObject *)__contactNameProperty:(ABRecordRef)recordRef
{
 ...
 *  获得工作的相关属性
 */
+ (KYContactJobObject *)__contactJobProperty:(ABRecordRef)recordRef
{
 ...
 *  获得Email对象的数组
 */
+ (NSArray <KYContactEmailObject *> *)__contactEmailProperty:(ABRecordRef)recordRef
{
    //获取多值属性
    ABMultiValueRef values = ABRecordCopyValue(recordRef, kABPersonEmailProperty);
    
    //外传数组
    NSMutableArray <KYContactEmailObject *> * emails = [NSMutableArray arrayWithCapacity:ABMultiValueGetCount(values)];
 ...
 *  获得Address对象的数组
 */
+ (NSArray <KYContactAddressObject *> *)__contactAddressProperty:(ABRecordRef)recordRef
{
    //获取多指属性
    ABMultiValueRef values = ABRecordCopyValue(recordRef, kABPersonAddressProperty);
    
    //外传数组
    NSMutableArray <KYContactAddressObject *> * addresses = [NSMutableArray arrayWithCapacity:ABMultiValueGetCount(values)];
 ...
 *  获得电话号码对象数组
 */
+ (NSArray <KYContactPhoneObject *> *)__contactPhoneProperty:(ABRecordRef)recordRef
{
    //获得电话号码的多值对象
    ABMultiValueRef values = ABRecordCopyValue(recordRef, kABPersonPhoneProperty);
    
    //外传数组
    NSMutableArray <KYContactPhoneObject *> * phones = [NSMutableArray arrayWithCapacity:ABMultiValueGetCount(values)];
 ...
 *  获得生日的相关属性
 */
+ (KYContactBrithdayObject *)__contactBrithdayProperty:(ABRecordRef)recordRef
{
    //实例化对象
 ...
 *  获得联系人类型信息
 */
+ (KYContactType)__contactTypeProperty:(ABRecordRef)recordRef
{
    //获得类型属性
    ...
    if (CFNumberCompare(typeIndex, kABPersonKindOrganization, nil) == kCFCompareEqualTo)
    {
        ...
        return KYContactTypeOrigination;
    }
 ...
 *  获得即时通信账号相关信息
 */
+ (NSArray <KYContactInstantMessageObject *> *)__contactMessageProperty:(ABRecordRef)recordRef
{
    //获取数据字典
    ABMultiValueRef messages = ABRecordCopyValue(recordRef, kABPersonInstantMessageProperty);
    
    //存放数组
    NSMutableArray <KYContactInstantMessageObject *> * instantMessages = [NSMutableArray arrayWithCapacity:ABMultiValueGetCount(messages)];
    ...
    for (NSInteger i = 0; i < count; i++)
    {
        ...
        //实例化
        KYContactInstantMessageObject * instantMessageObject = [[KYContactInstantMessageObject alloc]init];
 ...
 *  获得联系人的关联人信息
 */
+ (NSArray <KYContactRelatedNamesObject *> *)__contactRelatedNamesProperty:(ABRecordRef)recordRef
{
    //获得多值属性
    ...
    //存放数组
    NSMutableArray <KYContactRelatedNamesObject *> * relatedNames = [NSMutableArray arrayWithCapacity:count];
    ...
    {
        //初始化
        KYContactRelatedNamesObject * relatedName = [[KYContactRelatedNamesObject alloc]init];
 ...
 *  获得联系人的社交简介信息
 */
+ (NSArray <KYContactSocialProfileObject *> *)__contactSocialProfilesProperty:(ABRecordRef)recordRef
{
    //获得多值属性
    ...
    //外传数组
    NSMutableArray <KYContactSocialProfileObject *> * socialProfiles = [NSMutableArray arrayWithCapacity:count];
...
@implementation KYAddressBookContactObjectManager (ABRecordRef)
...
/**
 ...
 @param contact     添加的KYContactObject对象
 */
+ (BOOL)__nameObject:(ABRecordRef)recordRef object:(KYContactObject *)contact
{
    CFErrorRef error = NULL;
    
    //获得名字对象
    KYContactNameObject * nameObject = contact.nameObject;
...
/**
 ...
 @param contact   添加的KYContactObject对象
 */
+(BOOL)__contactType:(ABRecordRef)recordRef object:(KYContactObject *)contact
{
    CFErrorRef error = NULL;
    
    CFNumberRef type = (contact.type == KYContactTypePerson ? kABPersonKindPerson:kABPersonKindOrganization);
...
/**
 ...
 @param contact   添加的KYContactObject对象
 */
+(BOOL)__headImage:(ABRecordRef)recordRef object:(KYContactObject *)contact
{
    CFErrorRef error = NULL;
...
/**
 ...
 @param contact   添加的KYContactObject对象
 */
+(BOOL)__contactPhone:(ABRecordRef)recordRef object:(KYContactObject *)contact
{
    CFErrorRef error = NULL;
    ABMultiValueRef phoneMultiValue = ABMultiValueCreateMutable(kABMultiStringPropertyType);
    
    for (KYContactPhoneObject * phoneObject in contact.phoneObject)
    {
...
/**
 ...
 @param contact   添加的KYContactObject对象
 */
+(BOOL)__contactJob:(ABRecordRef)recordRef object:(KYContactObject *)contact
{
    CFErrorRef error = NULL;
...
/**
 ...
 @param contact   添加的KYContactObject对象
 */
+(BOOL)__contactEmail:(ABRecordRef)recordRef object:(KYContactObject *)contact
{
    CFErrorRef error = NULL;
    ...
    for (KYContactEmailObject * emailObject in contact.emailAddresses)
    {
        ABMultiValueIdentifier identifier;
...
/**
 ...
 @param contact   添加的KYContactObject对象
 */
+(BOOL)__contactAddress:(ABRecordRef)recordRef object:(KYContactObject *)contact
{
    CFErrorRef error = NULL;
    ...
    for (KYContactAddressObject * addressObject in contact.addresses)
    {
        ABMultiValueIdentifier identifier;
...
/**
 ...
 @param contact   添加的KYContactObject对象
 */
+(BOOL)__contactBrithday:(ABRecordRef)recordRef object:(KYContactObject *)contact
{
    CFErrorRef error = NULL;
